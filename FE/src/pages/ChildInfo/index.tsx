...
const UpdateBtn: React.FC<UpdateBtnProps> = ({
  onClick,
  childId,
  children,
}) => {
...
function ChildInfo() {
  ...
  const [selectedChildIdx, setSelectedChildIdx] = useState<number | undefined>(
    undefined
  );
            ...
            {children.map((child: ChildData) => (
              <Slide key={child.childIdx}>
                ...
                <BtnWrapper>
                  ...
                  <DeleteBtn onClick={() => handleDeleteChild(child.childIdx)}>
                    삭제
                  </DeleteBtn>
                </BtnWrapper>
              </Slide>
